...
<script type="text/javascript">
    ...
    <c:forEach var='key' items='${["common.deleted", "common.saved", "common.enabled", "common.disabled", "common.errorStatus", "common.confirm", "common.validation", "common.notempty"]}'>
